...
// ../.wrangler/tmp/bundle-dBwuId/checked-fetch.js
...
var cachedData = null;
var cachedAt = 0;
var CACHE_DURATION_MS = 30 * 1e3;
async function handleTrackRequest(request, kvNamespace) {
  let eventData = await request.json();
  ...
  eventData.timestamp = (/* @__PURE__ */ new Date()).toISOString();
...
// ../.wrangler/tmp/pages-cWGdPU/functionsRoutes-0.06796550227350484.mjs
var routes = [
  {
    routePath: "/api/:path*",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-dBwuId/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-dBwuId/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5599812604700183.mjs.map
