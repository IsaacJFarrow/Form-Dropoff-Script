...
export function Content({
  ...
  eyebrowText = "Why go with What IFWeb",
  eyebrowVisibility = true,
  heading = "The Difference Isn’t Just In The price. It’s In The Results.",
  paragraph = "Why go with What IF Web? Because we don’t just build websites, we unblock bottlenecks, speed up your roadmap, and help you grow faster! Whether you’re stuck with a clunky CMS, an agency that takes forever to reply, or DIY fatigue, we're here to help. Our affordable website design doesn’t cut corners - it cuts through the noise, delivering websites & brands that are fast, beautiful, and structurally sound. Curious about affordable website design? Let’s just say, the real cost is not building with us.",
}) {
  _interactions.useInteractions(_interactionsData);
  return (
    <_Component className="section_content" tag="section">
      <_Builtin.Block
        className="padding-global padding-section-large"
        tag="div"
      >
        <_Builtin.Block className="container-large" tag="div">
          <_Builtin.Grid className="content_component" tag="div">
            <_Builtin.Block className="content_content-left" tag="div">
              {eyebrowVisibility ? (
                <_Builtin.Block
                  className="margin-bottom margin-xsmall"
                  tag="div"
                >
                  <_Builtin.Block className="text-style-tagline" tag="div">
                    {eyebrowText}
                  </_Builtin.Block>
                </_Builtin.Block>
              ) : null}
              <_Builtin.Heading tag="h2" id="pricing-about-heading">
                {heading}
              </_Builtin.Heading>
            </_Builtin.Block>
            <_Builtin.Block className="content_content-right" tag="div">
              <_Builtin.Paragraph className="text-size-medium text-weight-medium">
                {paragraph}
              </_Builtin.Paragraph>
            </_Builtin.Block>
          </_Builtin.Grid>
