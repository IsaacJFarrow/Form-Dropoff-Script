...
export function Points({
  ...
  heading = "This Ain’t Yo Daddy's SEOAudit!",
  paragraph = "We go through your website in a video recording, shwoing what could be costing you leads and rubbing your visitors the wrong way.",
  item1Text = "Delivered in 2–3 working days",
  item1Visibility = true,
  item2Text = "A personalised video walkthrough of your website",
  item2Visibility = true,
  item3Text = "Real, actionable ways to get more out of your website",
  item3Visibility = true,
  item4Text = "100% FREE",
  item4Visibility = true,
  item5Text = "No meetings needed, we just send you the video link",
  item5Visibility = true,
}) {
  _interactions.useInteractions(_interactionsData);

  return (
    <_Component className="section_points" tag="section">
      <_Builtin.Block
      ...
      >
        <_Builtin.Block className="container-large" tag="div">
          <_Builtin.Block
            className="points_component"
            data-w-id="f5281bca-efa6-2c17-a9ff-0531516d8217"
            tag="div"
          >
            <_Builtin.Block
              className="points_content-left"
              id="w-node-f5281bca-efa6-2c17-a9ff-0531516d8218-516d8214"
              tag="div"
            >
              {eyebrowVisibility ? (
                <_Builtin.Block
                  className="text-weight-semibold text-color-orange"
                  tag="div"
                >
                  {eyebrowText}
                </_Builtin.Block>
            ...
            <_Builtin.Block
              className="points_content-right"
              id="w-node-f5281bca-efa6-2c17-a9ff-0531516d821d-516d8214"
              tag="div"
            >
              <_Builtin.Paragraph className="text-size-medium text-weight-medium text-color-primary-light">
                {paragraph}
              </_Builtin.Paragraph>
              <_Builtin.Block className="points_list-wrapper" tag="div">
                {item1Visibility ? (
                  <_Builtin.Block className="points_list-item" tag="div">
                    <_Builtin.Block className="points_list-dot" tag="div" />
                    <_Builtin.Paragraph className="text-color-secondary-light">
                      {item1Text}
                    </_Builtin.Paragraph>
                  </_Builtin.Block>
                ) : null}
